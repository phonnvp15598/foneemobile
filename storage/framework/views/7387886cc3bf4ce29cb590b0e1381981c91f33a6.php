								...
								<div class="sidebar_widget">
									...
									<div class="widget-content">
										<div class="list list-sidebar-products">
										  <div class="grid">
											<?php $__currentLoopData = $blog_popular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<div class="grid__item">
												<div class="mini-list-item">
												  <div class="mini-view_image"> <a class="grid-view-item__link" href="<?php echo e(URL::to('blog/'.$pop->blog_slug)); ?>"><img class="grid-view-item__image" src="<?php echo e(URL::to('public/uploads/product/'.$pop->blog_thumb)); ?>" alt="" /></a> </div>
												  <div class="details"> <a class="grid-view-item__title" href="<?php echo e(URL::to('blog/'.$pop->blog_slug)); ?>"><?php echo e($pop->blog_title); ?></a>
													<div class="grid-view-item__meta"><i style="font-size: 13px"><i class="fa fa-clock-o"></i> <?php echo e(date_format($pop->created_at,'d/m/y H:i')); ?></i></div>
												  </div>
												</div>
											  </div>
...
</html><?php /**PATH C:\xampp\htdocs\foneemobile\resources\views/blog.blade.php ENDPATH**/ ?>