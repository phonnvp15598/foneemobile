...
<body>
	...
	<div class="navi"> 
		...
		<div class="navigation">
			...
			<!--menu----------------->
			<ul class="menu">
				<li><a href="<?php echo e(url('/')); ?>"><i class="fa fa-home" aria-hidden="true"></i> Trang chủ</a></li>
				<li ><a href="<?php echo e(url('/product')); ?>" ><i class="fa fa-anchor" aria-hidden="true"></i> Sản phẩm</a></li>
				<li><a href="<?php echo e(url('/blog')); ?>"><i class="fa fa-book" aria-hidden="true"></i> Tin tức</a>
				</li>
				...
				<ul class="dropdown-menu fix-sub-menu">
					...
					<li class="user-header sub-menu" role="menu">
						<?php 
							...
							if($customer_id != null){
							?>
								<a href="<?php echo e(URL::to('/logout')); ?>"><i class="fa fa-sign-in"></i> Đăng xuất</a>
								<a href="<?php echo e(route('customer.history')); ?>"><i class="fa fa-repeat"></i> Lịch sử</a>
							<?php
							}
							else {
							?>
								<a href="<?php echo e(url('/login')); ?>"><i class="fa fa-plus"></i> Đăng ký</a>
								<a href="<?php echo e(URL::to('/login')); ?>"><i class="fa fa-sign-in"></i> Đăng nhập</a>
	...
	<?php
	 ...
	 <div class="search-bar">	
        ...
        <button type="submit" class="search-cancel">
            <i class="fa fa-search"></i>
		</button>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">								
								<div class="col-sm-12">
									<img src="<?php echo e(asset('public/frontend/images/slide1.png')); ?>" alt="" />								
								</div>
							</div>
							<div class="item">								
								<div class="col-sm-12">
									<img src="<?php echo e(asset('public/frontend/images/slide2.png')); ?>"  alt="" />
								</div>
							</div>							
							<div class="item">	
								<div class="col-sm-12">
									<img src="<?php echo e(asset('public/frontend/images/slide3.png')); ?>" alt="" />
								</div>
							</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							<h2>Thương hiệu (<?php echo e(count($brand_product)); ?>)</h2>
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<?php $__currentLoopData = $brand_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li><a  href="<?php echo e(URL::to('/brand/'.$brand->brand_slug)); ?>"> <span class="pull-right"></span><?php echo e($brand->brand_name); ?></a></li>
						...
						<div class="brands_products"><!--brands_products-->
							<h2>Lọc theo giá <i class="fa fa-filter"></i></h2>
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a class="<?php echo e(Request::get('price') == 1 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 1])); ?>"> Dưới 1.000.000 VND</a></li>
									<li><a class="<?php echo e(Request::get('price') == 2 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 2])); ?>"> 1.000.000 - 3.000.000 VND</a></li>
									<li><a class="<?php echo e(Request::get('price') == 3 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 3])); ?>"> 3.000.000 - 5.000.000 VND</a></li>
									<li><a class="<?php echo e(Request::get('price') == 4 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 4])); ?>"> 5.000.000 - 10.000.000 VND</a></li>
									<li><a class="<?php echo e(Request::get('price') == 5 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 5])); ?>"> 10.000.000 - 20.000.000 VND</a></li>
									<li><a class="<?php echo e(Request::get('price') == 6 ? 'active' : ''); ?>" href="<?php echo e(request()->fullUrlWithQuery(['price' => 6])); ?>"> Trên 20.000.000 VND</a></li></h3>
								</ul>
							</div>
						</div><!--/brands_products-->
						<div class="brands_products"><!--brands_products-->
								...
								<div class="sidebar_widget">
									...
									<div class="widget-content">
										<div class="list list-sidebar-products">
										  <div class="grid">
											<?php $__currentLoopData = $popular_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<div class="grid__item">
												<div class="mini-list-item">
												  <div class="mini-view_image"> <a class="grid-view-item__link" href="<?php echo e(URL::to('product/'.$pop->product_slug)); ?>"><img class="grid-view-item__image" src="<?php echo e(URL::to('public/uploads/product/'.$pop->product_image)); ?>" alt="" /></a> </div>
												  <div class="details"> <a class="grid-view-item__title" href="<?php echo e(URL::to('product/'.$pop->product_slug)); ?>"><?php echo e($pop->product_name); ?></a>
													<div class="grid-view-item__meta"><span class="product-price__price"><span class="money"><?php echo e(number_format($pop->product_price, 0, '.','.')); ?> Đ</span></span></div>
												  </div>
												</div>
											  </div>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="container">
		<?php echo $__env->yieldContent('relative'); ?>
	</div>
...
</html><?php /**PATH C:\xampp\htdocs\foneemobile\resources\views/welcome.blade.php ENDPATH**/ ?>