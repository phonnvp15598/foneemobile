	...
	<div class="navi"> 
		...
		<div class="navigation">
			...
			<div class="right-menu" >
				...
				{{-- <a href="javascript:void(0);" class="search form-inline">
				...
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">								
								<div class="col-sm-12">
									<img src="{{asset('public/frontend/images/slide2.png')}}"  alt="" />
								</div>
							</div>							
							<div class="item">	
								<div class="col-sm-12">
									<img src="{{asset('public/frontend/images/slide3.png')}}" alt="" />
								</div>
							</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							<h2>Thương hiệu ({{count($brand_product)}})</h2>
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									@foreach ($brand_product as $key => $brand)
										<li><a  href="{{URL::to('/brand/'.$brand->brand_slug)}}"> <span class="pull-right"></span>{{$brand->brand_name}}</a></li>
									@endforeach									
								</ul>
							</div>
						</div><!--/brands_products-->
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a class="{{Request::get('price') == 2 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 2])}}"> 1.000.000 - 3.000.000 VND</a></li>
									<li><a class="{{Request::get('price') == 3 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 3])}}"> 3.000.000 - 5.000.000 VND</a></li>
									<li><a class="{{Request::get('price') == 4 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 4])}}"> 5.000.000 - 10.000.000 VND</a></li>
									<li><a class="{{Request::get('price') == 5 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 5])}}"> 10.000.000 - 20.000.000 VND</a></li>
									<li><a class="{{Request::get('price') == 6 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 6])}}"> Trên 20.000.000 VND</a></li></h3>
								</ul>
							</div>
						</div><!--/brands_products-->
						<div class="brands_products"><!--brands_products-->
